    ...
    <Container className="py-16 sm:py-20">
      <Reveal className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-4 text-lg text-sea-800/80">
          A look back at our tours along Montenegro&apos;s coast.
        </p>
      </Reveal>
      ...
      <Reveal className="mx-auto mt-14 max-w-2xl">
        <div className="card-soft rounded-3xl bg-gradient-to-br from-sea-600 to-sea-900 p-8 text-center text-white sm:p-10">
